...
@section('content')
                ...
                <div class="col-12 col-md-6">
                    <div class="about-content mb-100">
                        ...
                        <h6 class="mb-4">
                            ...
                            ​ "Paramount among measures that will liberate and augment the nation is the establishment of a bank, utterly modern and   national in identity, born directly out of the people's respect and confidence..."  ​</h6>
                        <p class="mb-0">These words uttered by Mustafa Kemal before the Council of Ministers which summoned in July 1924, express his aspirations for the foundation of a national bank.</p>
    ...
    <section class="cta-area d-flex flex-wrap">
        ...
        <div class="cta-content">
            ...
            <h6 class="mb-0">Since inception,the team of {{ env('APP_NAME') }} Bank have been striving and we are proud with our achievements so far.</h6>
